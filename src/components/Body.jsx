        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                <div className="text-center">
                    ...
                    <h6 className="text-4xl font-bold text-deep-purple-accent-400">25000+</h6>
                    <p className="mb-2 font-bold text-md">Student Counselled</p>
                </div>
                <div className="text-center">
                    <div className="flex items-center justify-center w-10 h-10 mx-auto mb-3 rounded-full bg-indigo-50 sm:w-12 sm:h-12">
                        <svg className="w-8 h-8 text-deep-purple-accent-400 sm:w-10 sm:h-10" stroke="currentColor" viewBox="0 0 52 52">
                    ...
                    <h6 className="text-4xl font-bold text-deep-purple-accent-400">3000+</h6>
                    <p className="mb-2 font-bold text-md">Placed Successfully</p>
                </div>
                <div className="text-center">
                    <div className="flex items-center justify-center w-10 h-10 mx-auto mb-3 rounded-full bg-indigo-50 sm:w-12 sm:h-12">
                        <svg className="w-8 h-8 text-deep-purple-accent-400 sm:w-10 sm:h-10" stroke="currentColor" viewBox="0 0 52 52">
                    ...
                    <h6 className="text-4xl font-bold text-deep-purple-accent-400">99%</h6>
                    <p className="mb-2 font-bold text-md">Visa Success Rate</p>
                </div>
                <div className="text-center">
                    <div className="flex items-center justify-center w-10 h-10 mx-auto mb-3 rounded-full bg-indigo-50 sm:w-12 sm:h-12">
                        <svg className="w-8 h-8 text-deep-purple-accent-400 sm:w-10 sm:h-10" stroke="currentColor" viewBox="0 0 52 52">
                    ...
                    <h6 className="text-4xl font-bold text-deep-purple-accent-400">20+</h6>
                    <p className="mb-2 font-bold text-md">Years of Experience</p>
                </div>
            </div>
            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                ...
                <div className="grid grid-cols-2 gap-5 row-gap-6 mb-10 sm:grid-cols-3 lg:grid-cols-6">
                    <div className="text-center">
                        ...
                        <h6 className="mb-2 font-semibold leading-5">No/Low Tuition Fee</h6>
                    </div>
                    <div className="text-center">
                        <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-indigo-50 sm:w-24 sm:h-24">
                            <svg
                        ...
                        <h6 className="mb-2 font-semibold leading-5">Higher Ranked University</h6>
                    </div>
                    <div className="text-center">
                        <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-indigo-50 sm:w-24 sm:h-24">
                            <svg
                        ...
                        <h6 className="mb-2 font-semibold leading-5">Better Job Prospects</h6>
                    </div>
                    <div className="text-center">
                        <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-indigo-50 sm:w-24 sm:h-24">
                            <svg
                        ...
                        <h6 className="mb-2 font-semibold leading-5">Skill Based Programs</h6>
                    </div>
                    <div className="text-center">
                        <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-indigo-50 sm:w-24 sm:h-24">
                            <svg
                        ...
                        <h6 className="mb-2 font-semibold leading-5">On the Job Training</h6>
                    </div>
                    <div className="text-center">
                        <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 rounded-full bg-indigo-50 sm:w-24 sm:h-24">
                            <svg
                        ...
                        <h6 className="mb-2 font-semibold leading-5">Scholarships & Financial Aid</h6>
                    </div>
                </div>
                <div className="text-center">
                    {/* <a
